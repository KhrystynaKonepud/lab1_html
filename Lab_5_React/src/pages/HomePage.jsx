...
export default function HomePage() {
  ...
  return (
    <Container as="main" className="my-4">
      <article
        className="p-4 mx-auto float-in"
        style={{
          maxWidth: '1100px',
          backgroundColor: 'rgba(230, 242, 255, 0.6)',
          borderLeft: '4px solid var(--bright)',
          borderRight: '4px solid var(--bright)',
          maxHeight: '260px',
          overflowY: 'auto'
        }}
      >
        <h2 className="mb-3" style={{ color: 'var(--accent-blue)' }}>
          Мета створення корпорації 👨‍💼
        </h2>
        <hr style={{ borderColor: 'var(--accent-blue)' }} />
      ...
      <h3 className="ms-5 mt-4 mb-3">Завдання для досягнення мети:</h3>
      <ol type="I" className="ms-5">
      ...
      <div className="text-center my-5">
        <Table bordered hover responsive className="mx-auto" style={{ maxWidth: '900px' }}>
      ...
      <aside className="mx-5 my-4">
        <h3 style={{ color: 'var(--accent-blue)' }}>Корисні посилання</h3>
